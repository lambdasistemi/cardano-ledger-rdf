...
The 30 May 2026 seed txids are pinned inline as the `VALUES` block
below — these are the first 30 lines of [`selections.txt`](../selections.txt)
and form the contract of this case study (any reader can re-run the
query against the same lattice and reproduce the result).
...
| input lovelace          | output lovelace         | fee lovelace | gap |
|------------------------:|------------------------:|-------------:|----:|
| 22,186,097,902,390      | 22,186,077,970,992      | 19,931,398   | **0** |

In ADA (lovelace ÷ 10⁶): **22,186,097.902390 ADA in, 22,186,077.970992 ADA
out, 19.931398 ADA fee, gap 0.000000 ADA**.
