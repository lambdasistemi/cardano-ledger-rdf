...
| `f5f1bdfad3eb4d67...`              | 0         | 2                   |

The first four hot reference UTxOs are each pulled in by 27–28 of
the 30 seed transactions — the canonical published treasury and
Sundae V3 order scripts. CIP-31 reference inputs are doing what
they're designed to do: one script body on chain, every consumer
points at the same output instead of re-embedding it.
