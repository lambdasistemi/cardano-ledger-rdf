...
|-------------------------------------------|--------------:|--------------:|--------------:|
| amaru-treasury.contingency                |  3,852,000.000000 |  4,057,000.000000 |    **−205,000.000000** |
| amaru-treasury.network_compliance         | 14,923,951.458216 | 16,209,772.179866 | **−1,285,820.721650** |
| amaru.cag-payee                           |          2.379120 |          0.000000 |          **+2.379120** |
| amaru.network-wallet                      |      2,391.518562 |      2,410.553271 |            **−19.034709** |
| other (sundae.swap.v3.order + pools + scoopers + …) | 3,407,732.615094 | 1,916,915.169253 | **+1,490,817.445841** |

Sum of `net` = −19.931398 ADA = the total of Q1 fees (perfect
conservation). The 205,000 ADA disburse left contingency and landed at
network_compliance; another 1.286 M ADA left network_compliance into
Sundae V3 order UTxOs (recovered as USDM on the scoop side).

```mermaid
flowchart LR
  cont["contingency<br/>net −205,000 ADA"] -->|205k ADA disburse| netcomp["network_compliance<br/>net −1,285,820 ADA"]
  netcomp -->|"swap orders<br/>(ADA → sundae.swap.v3.order)"| swap["sundae.swap.v3.order / pools / scoopers<br/>net +1,490,817 ADA"]
  swap -.->|"USDM proceeds back<br/>(see Q7)"| netcomp
  netwallet["network-wallet<br/>−19 ADA gas"]
