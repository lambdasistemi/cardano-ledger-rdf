...
This query runs against the full lattice (seeds + closure parents) —
it doesn't need a seed gate because the USDM landings inside the
30 seed outputs already produce the same three-row answer.
...
| destination (truncated)                | USDM (raw)        | USDM        |
|----------------------------------------|------------------:|------------:|
| `addr1xyezq8w...` (network_compliance) | 1,146,156,659,602 | 1,146,156.659602 |
| `addr1z8srqftq...` (SundaeSwap pool)   |   490,819,149,109 |   490,819.149109 |
| `addr1q8qrds2n...` (cag-payee)         |   418,750,000,000 |   418,750.000000 |

(USDM has 6 decimals; divide raw by 10⁶ for the human-readable column.)
