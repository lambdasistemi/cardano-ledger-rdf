{- |
Module      : Fixtures.TxGraph.S08_ContingencyDisburse
...
resolve to the same @amaru-treasury.contingency.account@ entity. That
shared resolution is the #43 reproducer trigger for the tx-graph emitter.
...
in @rules.yaml@ and is verified by the tx-graph Turtle golden, not here.
