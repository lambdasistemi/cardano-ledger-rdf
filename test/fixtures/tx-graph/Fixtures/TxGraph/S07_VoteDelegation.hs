{- |
Module      : Fixtures.TxGraph.S07_VoteDelegation
...
entity in the expected output via the tx-graph emitter.
...
that distinction is exercised by the rules-overlay emit path against
