{- |
Module      : Fixtures.TxGraph.S03_MultiAssetTransfer
...
@assets:@ multi-asset shape are exercised by the tx-graph emitter against
@rules.yaml@'s @entities:@ list, not by 'assertShape'
