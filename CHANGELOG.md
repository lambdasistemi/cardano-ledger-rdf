...
## [0.2.2.0](https://github.com/lambdasistemi/cardano-rdf/releases/tag/v0.2.2.0) (2026-05-26)

### Features

* Initial `cardano-rdf` repository extraction from the graph/RDF surface of `cardano-tx-tools`.
